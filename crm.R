...
##############################################
# Hard coded target.crm parameter = 0.
target.crm <- 0
##############################################
...
#crmOut <- my.crm(prior=c(0.05,0.1,0.2,0.3), target.tox=0.2, number.trials=100, true.tox=c(0.05,0.12,0.20,0.30), arrival.rate=15, prop.B=0.1, min.cohortB=0, 
