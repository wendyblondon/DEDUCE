...
```{r, echo=FALSE}
knitr::kable(params$df2, col.names = c("Dose Level", "Prior Toxicity", "n", "Total Experiencing a DLT", "Probability Toxicity", "Lower", "Upper"), caption = "(90 Percent Probability Interval)")
```
