...
Trial operating characteristics are averaged over **`r params$m[1]`** simulated trials. Simulated trials have **`r params$m[2]`** dose levels labeled **`r params$m[3]`**, starting on dose level **`r params$m[4]`**, and assuming true toxicity probabilities of **`r params$m[5]`**. The target toxicity probability is **`r params$m[6]`**. One patient arrives every **`r params$m[7]`** days on average. The DLT observation period is **`r params$m[8]`** days.
...
<!-- Only Show if TARGET-CRM is a Design Used -->
`r if(!show_text_results) {"<!--"}`

**Enrollment of Cohort B Patients:** The proportion of patients in the population belonging to Cohort B is **`r params$r[12]`**. The mean number of Cohort B patients enrolled during the DLT observation period is **`r params$r[13]`**. (SD=**`r params$r[14]`**)
...
**Enrollment of Cohort B Patients:** The proportion of patients in the population belonging to Cohort B is **`r params$r[10]`**. The mean number of Cohort B patients enrolled during the DLT observation period is **`r params$r[11]`**. (SD=**`r params$r[12]`**)
