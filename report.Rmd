...
*Software:* DEDUCE app version 1.0 available [here](https://bengarski.shinyapps.io/DELPHI/) 


# Objective:

To evaluate the operating characteristics of the following dose escalation designs: **`r params$d`**
...
**Accuracy:** For each dose level, Figure 1 presents the proportion of simulated trials that a given dose level was selected as the true MTD. The proportion of correct selection (PCS) of the MTD for the **`r params$d`** design is.
