...
`r if(!show_text_reports) {"<!--"}`

**Enrollment of Cohort B Patients:** The proportion of patients in the population belonging to Cohort B is **`r params$r[12]`**. The mean number of Cohort B patients enrolled during the DLT observation period is **`r params$r[13]`**. (SD=**`r round(params$r[14],2)`**)
