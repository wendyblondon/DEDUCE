...
MTD.selection.table = MTD.selection.table, true.MTD=true.MTD, PCS=PCS, patient.allocation.table=patient.allocation.table, obs.tox.table=obs.tox.table,
...
# Scenario 1
set.seed(7652)
out1 <- target.crm(prior=c(0.05,0.1,0.2,0.3), target.tox=0.2, 
