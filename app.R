                    ...
                    dashboardSidebar(
                      useShinyjs(), includeCSS("www/style.css"), useShinyFeedback(), use_waiter(),
                                     sidebarMenu(
                                                 ...
                                                 menuItem("HELP", href="https://urldefense.com/v3/__https://drive.google.com/file/d/18MGkaaIYFfJ5gqi1vGqnf7Myy0QjLs-i/view__;!!IqRYp603ny2KL2MbNA!jYGP4Hl2H8orSVvOGpBJDaN10jwHgo94JCUkjOrh-uUos7FiLe4VAhbjr9zKO_RhPBX0KtAg5lof$ "),
...
#*
                        tabItem(tabName = "Home",
                                ...
                                h2("DEDUCE Modules:"),
                                  h4(id="overview","DESIGN YOUR TRIAL"),
                                    p(id="overview","Users can specify and compare the operating characteristics for hypothetical phase 1 designs through trial simulations,
                                    and select an optimal desigGITn for the needs of the trial."),
                                  h4(class="trialdc", "CONDUCT YOUR TRIAL"),
                                    p(id="overview","Users can implement the adaptive trial, and determine the recommended dose level each time a new patient enrolls."),

                                h2("Available Designs:"),
                                tags$ul(
                                  tags$li(
                                    p("Continual Reassessment Method (CRM) ", a(href="https://urldefense.com/v3/__https://pubmed.ncbi.nlm.nih.gov/2350571/__;!!IqRYp603ny2KL2MbNA!jYGP4Hl2H8orSVvOGpBJDaN10jwHgo94JCUkjOrh-uUos7FiLe4VAhbjr9zKO_RhPBX0KtuuoEVK$ ", "[O'Quigley et al. ", em("Biometrics,"), " 1990]", target="_blank", rel="noopener noreferrer"))
                                  ),
                                  tags$li(
                                    p("TARGETed-Agent Continual Reassessment Method (TARGET-CRM)")
                                  ),
                                  tags$li(
                                    p("3+3 ", a(href="https://urldefense.com/v3/__https://pubmed.ncbi.nlm.nih.gov/2790129/__;!!IqRYp603ny2KL2MbNA!jYGP4Hl2H8orSVvOGpBJDaN10jwHgo94JCUkjOrh-uUos7FiLe4VAhbjr9zKO_RhPBX0Krikppv6$ ", "[Storer. ", em("Biometrics,"), " 1989]", target="_blank", rel="noopener noreferrer"))
                                  )
                                ),
                                ...
                                fluidRow(id="logofooter",
                                  column(12, align="center",
                                         a(href="https://urldefense.com/v3/__https://www.danafarberbostonchildrens.org__;!!IqRYp603ny2KL2MbNA!jYGP4Hl2H8orSVvOGpBJDaN10jwHgo94JCUkjOrh-uUos7FiLe4VAhbjr9zKO_RhPBX0Kjrzy5kf$ ", img(id="DFLogo", src = "1deduce-sponsor-logo-left.jpg", style="cursor: pointer;"), target="_blank", rel="noopener noreferrer"),
                                ...
                                fluidRow(
                                  column(3, style="overflow-y:scroll; height: 70vh;",
                                         ...
                                         bsTooltip("dt_target_tox", "Please enter the target toxicity probability of the study agent",
                                                   "top", options = list(container = "body")),
                                         textInput("dt_true_tox", "True Toxicity Probability per Dose Level", value = "0.05,0.12,0.2,0.3", width = "100%"),
                                         ...
                                         conditionalPanel(condition = "input.dt_selector_tcrm == 1 || input.dt_selector_crm == 1",
                                           textInput("dt_prior_tox", "Prior Toxicity Probability per Dose Level", value = "0.05,0.12,0.2,0.3", width = "100%"),
                                           ...
                                           bsTooltip("dt_max_n", "Please enter the maximum number of patients to be enrolled per trial. Trial accuracy increases with larger sample size. The selected sample size should balance trial accuracy with accrual feasibility.",
                                                     "top", options = list(container = "body")),
