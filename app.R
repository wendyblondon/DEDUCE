                    ...
                    dashboardBody(
                      tabItems(
                        ...
                        tabItem(tabName = "About",
                                ...
                                tags$ul(
                                  tags$li(
                                    #p("To cite DEDUCE, please use: Ma C, Berdan J, Borchardt L, Crane S, Garski B, Jamel N, Kiraly L, Pankey D, Stegman S, London WB (2021). DEsign and conDUCt of dose Escalation trials (DEDUCE). Available at:", href="https://bengarski.shinyapps.io/DEDUCE/", target="_blank", rel="noopener noreferrer")
                                  )
                                ),
                                h2("Acknowledgements:"),
